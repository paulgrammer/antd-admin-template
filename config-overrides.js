...
const darkVars = {
    ...
    '@shadow-2':
        '0 6px 12px -4px rgba(0, 0, 0, 0.48), 0 12px 12px 0 rgba(0, 0, 0, 0.32), 0 18px 28px 8px rgba(0, 0, 0, 0.2)',
    ...themeVariables,
}
const lightVars = {
    ...
    '@primary-color': defaultVars['@primary-color'],
    '@shadow-2':
        '0 6px 12px -4px rgba(0, 0, 0, 0.12), 0 12px 12px 0 rgba(0, 0, 0, 0.08), 0 18px 28px 8px rgba(0, 0, 0, 0.05)',
    ...themeVariables,
}
